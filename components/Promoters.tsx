...
export default function Promoters() {
  ...
  return (
    <section className="section team" id="promoters" aria-labelledby="promoters-title">
      <div className="section__inner">
        <div className="reveal">
          <p className="section__tag">{managedConfig.promotersTag}</p>
          <h2 className="section__title" id="promoters-title" style={{ whiteSpace: "pre-line" }}>
            {managedConfig.promotersTitle}
          </h2>
          <p className="section__desc">{managedConfig.promotersDesc}</p>
        </div>
