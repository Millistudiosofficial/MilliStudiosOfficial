    ...
    <footer className="footer" id="footer" aria-label="Footer">
      <div className="footer__inner">
        ...
        <div className="footer__brand">
          ...
          <div>
            <h3 className="footer__brand-name">MilliStudiosOfficial</h3>
        ...
        <div className="footer__copyright">
          © {year} MilliStudiosOfficial.<br />All rights reserved.
        </div>

        {/* Right: Socials */ }
        <div className="footer__socials" style={{ gap: "24px", display: "flex", alignItems: "center", justifyContent: "center" }}>
